...
class FlexibleResponsePipeline:
    ...
    def _load_media_indexing_json(self):
        """Download and parse media_indexing.json for this media."""
        ...
        self.cloud_storage_client.download_files(
            BUCKET_NAME, gcs_index_path, index_local_path
        )
    ...
    async def run(self, user_prompt: str, video_response: bool):
        ...
        # 1. LLM: Generate the initial flexible response
        ...
        if not video_response:
            ...
            print("[INFO] Generating video clip plan for narration...")
