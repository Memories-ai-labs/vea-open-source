...
### Pipeline
Pipeline is the core functions for this repo, each pipeline should perform a core task in the video-editing workflow. For exammple, [summary_pipeline](./src/pipeline/summary_pipeline.py) implemnts the pipeline that generate a gist sumamry of the input video and output the summary in json format for future usage.
